    ...
    <Container className={classes.root}>
      <Box pt={4}>
        <Typography variant="body2" gutterBottom>
          ...
          into images. You can also find it on IPFS: <a href="https://cloudflare-ipfs.com/ipfs/QmWEao2HjCvyHJSbYnWLyZj8HfFardxzuNh7AUk1jgyXTm">ipfs://QmWEao2HjCvyHJSbYnWLyZj8HfFardxzuNh7AUk1jgyXTm</a>
        </Typography>
        <CodeMirror
          value={`
